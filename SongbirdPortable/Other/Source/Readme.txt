...
The WaitForSongbird entry allows you to set the launcher to remain active until Songbird has
closed.  This is useful if you wish to have another process wait until Songbird Portable
has closed.  The launcher will automatically wait for Songbird to close in cases where it
needs to clean up after Songbird.exe (for instance, to clean up %APPDATA%\Songbird2
when there is no locally-installed Songbird).
